...
| 日期       | 阶段   | 核心任务 / 知识点                        | 代码链接 / 笔记                          |
| :--------- | :----- | :--------------------------------------- | :--------------------------------------- |
| 2026-01-20 | Setup  | 环境配置 (GCC 12), Git 仓库初始化        | [Commit Link](./)                        |
| 2026-01-21 | Week01 | 理解 `unique_ptr` 内存布局，实现构造函数 | [Code](./01_Modern_Cpp/Week01_SmartPtr/) |
| ...        | ...    | ...                                      | ...                                      |
